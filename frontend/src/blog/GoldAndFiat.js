   ...
   return (
      <div className='blog'>
         ...
         <p className='blog__text'>
            ...
            ounce of gold.
            <br />
            Fiat currency (fiat is Latin for “it shall be”) on the other hand is
            not backed by anything. <br />
         ...
         <p className='blog__text'>
            ...
            spending and remove wealth from their citizens. <br />
            <br />
         ...
         <p className='blog__text'>
            ...
            <br />
            Temporary, is often said by politicians, but a big reason why they
            planned for it to be temporary it was because that they feared
            backlash for this drastic measure. Surprisingly there was little to
            nothing. <br />
            Needles to say we are still on this "backed by nothing" fiat
            currency today. <br />
